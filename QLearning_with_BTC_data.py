...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 14:36:30 2023
...
###This is an exercise in exploring Q-learning using BitCoin trend data
###The data and jupyter notebook are available on Kaggle: https://www.kaggle.com/code/kemquiros/q-learning-using-btc-dataset
###Data set: https://www.kaggle.com/datasets/billqi/binance-bitcoin-futures-price-10s-intervals/
...
#%%
#Import data
prices = np.loadtxt(r'Documents/Kaggle_data/archive/prices_btc_Jan_11_2020_to_May_22_2020.txt', dtype=float)
...
#%%
#plot price trends
plt.title("BTC Price Trends")
plt.plot(prices)
plt.show()

#%%
#Define functions to buy, sell, and wait
...
def wait(btc_price, btc, money):
    ...
    return btc, money
#%%
#Create actions, states, and tables
np.random.seed(1)
...
#%%
#Functions to get rewards and act upon actions
...
plt.title('BTC Price with Associated Actions')
plt.ylabel('BTC Price')
plt.legend('Blue: Buy | Red: Sell | Yellow | Wait')
